...
int main()
{
    ...
    sampler_parallel(low_bound_willingness_to_pay_basis_point, low_bound_samples, 16, n_samples);
    ...
    printf("a rough lower bound should be...\n");
    ...
    sampler_parallel(high_bound_willingness_to_pay_basis_point, high_bound_samples, 16, n_samples);
