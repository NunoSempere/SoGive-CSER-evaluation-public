...
double low_bound_willingness_to_pay_dollars_per_basis_point(uint64_t* seed){
...
double low_bound_bp_per_million(uint64_t* seed){
    double dollar_per_bp = low_bound_willingness_to_pay_dollars_per_basis_point(seed);
    double million_per_bp  = dollar_per_bp / MILLIONS;
    double bp_per_million = 1.0/million_per_bp;
    return bp_per_million;
}

// Based on the impression that humanity can't really spend all its future at once...
double high_bound_willingness_to_pay_dollars_per_basis_point(uint64_t* seed){
...
double high_bound_bp_per_million(uint64_t* seed){
    double dollar_per_bp = high_bound_willingness_to_pay_dollars_per_basis_point(seed);
    double million_per_bp  = dollar_per_bp / MILLIONS;
    double bp_per_million = 1.0/million_per_bp;
    return bp_per_million;
}
