...
int main()
{
    ...
    sampler_parallel(sample_value_cser_bps, results, n_threads, n_samples);

    printf("\n# Value of CSER's AI group, in basis points of existential risk averted: \n");
    printf("\nStats: \n");
    ...
    FILE *fp;
    fp = fopen("samples_cost_effectiveness_cser_bps_per_million.txt", "w");// "w" = write. destructive
